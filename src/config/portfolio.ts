...
export const PORTFOLIO_CONFIG = {
  ...
  tagline: 'Supporting reliable Linux systems and the applications that run on them.',
  bio: 'I began my career at Justdial in November 2021 and rejoined in June 2022 while pursuing a degree. Alongside Linux administration, I contribute to web development, application deployment, troubleshooting, and collaboration with development teams.',
